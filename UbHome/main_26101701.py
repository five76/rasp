       ...
       # print(self.rasp_for_view)
        try:
            ...
            #for i in range(0, len(rasp_s)):
                if rasp_s[0][0] == rasp_s[1][0]:
                    str1 = F"{rasp_s[0][0]} {rasp_s[0][3]} {rasp_s[0][2]} {rasp_s[0][4]}/{rasp_s[0+1][3]} {rasp_s[1][2]} {rasp_s[0+1][4]}"
                    print(str1)
                    rasp_s = rasp_s[2:]
                    #list_ur.append(F"{rasp_s[0][0]} {rasp_s[0][3]} {rasp_s[0][2]} {rasp_s[0][4]}/{rasp_s[0+1][3]}")
                    #0 += 1
                else:
                    str1 = f"{rasp_s[0][0]} {rasp_s[0][3]} {rasp_s[0][2]} {rasp_s[0][4]}"
                    print(str1)
                    rasp_s = rasp_s[1:]
                    #list_ur.append(f"{rasp_s[0][0]} {rasp_s[0][3]} {rasp_s[0][2]} {rasp_s[0][4]}")
            print(list_ur)
            #self.ids["itog"].text = k
            #self.ids["fio"].text = self.fi + '\n' + d
...
if __name__ == "__main__":
    ...
    #print(list_date)
    #print(list_group_spo)
   # print(list_group_npo)
